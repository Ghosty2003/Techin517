...
def launch_setup(context, *args, **kwargs):
    ...
    spawner_left_arm_fwd = Node(
        package='controller_manager',
        executable='spawner',
        arguments=['left_arm_fwd_controller', '--inactive'],
        output='screen',
    )
    spawner_right_arm_fwd = Node(
        package='controller_manager',
        executable='spawner',
        arguments=['right_arm_fwd_controller', '--inactive'],
        output='screen',
    )
    spawner_left_gripper_fwd = Node(
        package='controller_manager',
        executable='spawner',
        arguments=['left_gripper_fwd_controller', '--inactive'],
        output='screen',
    )
    spawner_right_gripper_fwd = Node(
        package='controller_manager',
        executable='spawner',
        arguments=['right_gripper_fwd_controller', '--inactive'],
        output='screen',
    )

    controller_switcher_left = Node(
        ...
        parameters=[{
            'initial_mode': 'jtc',
            'cm_service': '/controller_manager/switch_controller',
            'jtc_controllers': 'left_arm_controller,left_gripper_controller',
            'fcc_controllers': 'left_arm_fwd_controller,left_gripper_fwd_controller',
        }],
    )
    controller_switcher_right = Node(
        package='soa_functions',
        executable='controller_switcher',
        name='controller_switcher',
        namespace='right',
        ...
        parameters=[{
            'initial_mode': 'jtc',
            'cm_service': '/controller_manager/switch_controller',
            'jtc_controllers': 'right_arm_controller,right_gripper_controller',
            'fcc_controllers': 'right_arm_fwd_controller,right_gripper_fwd_controller',
        }],
    )
    ...
    actions = [
        ...
        spawner_left_arm_fwd,
        spawner_right_arm_fwd,
        spawner_left_gripper_fwd,
        spawner_right_gripper_fwd,
        controller_switcher_left,
        controller_switcher_right,
        moveit_rsp,
        static_tf,
        move_group,
        rviz,
