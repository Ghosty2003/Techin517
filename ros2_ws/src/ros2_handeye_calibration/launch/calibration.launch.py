...
def generate_launch_description():
    ...
    tracking_base_frame = DeclareLaunchArgument('tracking_base_frame', 
                                                 default_value="overhead_camoverhead_cam_color_optical_frame",
                                                 description="e.g. camera frame")
    tracking_marker_frame = DeclareLaunchArgument(
    ...
    robot_effector_frame = DeclareLaunchArgument(
        'robot_effector_frame',
        default_value="follower/gripper_link"
    )
