...
class DataCollector(Node):
    ...
    # get transforms 
        ...
        try:
            ...
            resp.success = False  # ADD THIS
            resp.message = str(ex)  # ADD THIS
            return resp  # ADD THIS - Exit early on error

        # Only execute this if transforms were successfully retrieved
