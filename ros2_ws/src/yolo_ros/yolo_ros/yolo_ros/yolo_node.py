...
class YoloNode(LifecycleNode):
    ...
    def __init__(self) -> None:
        ...
        # Add this line in __init__ after other declare_parameter calls
        self.declare_parameter("classes", ["scissors", "screwdriver", "pen", "tape", "pliers"])
    ...
    def on_activate(self, state: LifecycleState) -> TransitionCallbackReturn:
        ...
        try:
            ...
            # Add this block after self.yolo.to(self.device)
            if isinstance(self.yolo, YOLOWorld):
                ...
                self.get_logger().info(f"Setting classes: {hardcoded_classes}")
                self.yolo.set_classes(hardcoded_classes)
